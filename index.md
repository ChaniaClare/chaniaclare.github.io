...
<head>
    ...
    <style>
        ...
        header img {
            ...
            border-radius: 50%;
            margin-bottom: 1rem;
            transition: width 0.3s ease, height 0.3s ease, border-radius 0.3s ease, margin-bottom 0.3s ease;
        }
...
<body>
    ...
    <p>
        <em>2021 – Present</em>
        <br>
        Computational Systems and Synthetic Biology, PhD
    </p>
    <ul>
    ...
    <footer>
        <p>&copy; 2023 Chania Clare. All rights reserved.</p>
    </footer>
    ...
    <script>
        window.addEventListener("load", function() {
            // Replace "ChaniaNClare" with your actual Twitter username
